...
class ImportController extends CoreBaseController
{
    public function indexAction(Request $request)
    {
        ...
        if ($this->isUserAdmin() && $request->getMethod() == 'POST')
        {
        ...
        return $this->renderx('ZaysoArbiterBundle:Import:import.html.twig',$tplData);
    }
}
