    ...
    public function indexAction(Request $request)
    {
        ...
        if ($this->isAdmin() && $request->getMethod() == 'POST')
        {
            ...
            {   
                ...
                return $this->redirect($this->generateUrl('zayso_s5games_admin_import'));
        ...
        return $this->render('ZaysoS5GamesBundle:Admin:import.html.twig',$tplData);
    }
}
