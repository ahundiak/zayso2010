...
class AccountPersonEditFormType extends AccountBaseFormType
{
    protected $name = 'accountPersonEdit';
    protected $group = 'edit';

    // Leave for now as Primary should not be a choice
    protected $accountRelationPickList = array
    (
        'Primary' => 'Primary - Account Owner',
    ...
    public function buildForm(FormBuilder $builder, array $options)
    {
        ...
        $builder->add('region',    'text', array('label' => 'AYSO Region Number', 'read_only' => true, 'attr' => array('size' => 4)));
