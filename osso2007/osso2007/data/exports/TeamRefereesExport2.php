...
class TeamRefereesExport2 extends ExportBase
{
...
//			        	if ($event['point2'] == 1)  $referees[$refereeId]['points_processed'] += $points;
    	...
    	foreach($refereeTeams as $link)
    	{
    		...
    		{    			
    			if (isset($teams[$teamId]))
    			{
    				...
    				$teamx['priority']     = $link['pri_tourn']; // $link['pri_tourn'];
    				$teamx['points_max']   = $link['max_tourn']; // $link['max_tourn'];
 ...
 //Zend_Debug::dump($teamx);   				
    		...
    		if (isset($teams[$teamId]))
    		{
    			if (isset($referees[$refereeId])) 
    			{
    				...
    				$refereex['priority']   = $link['pri_tourn']; //$link['pri_tourn'];
    				$refereex['points_max'] = $link['max_tourn']; //$link['max_tourn'];
