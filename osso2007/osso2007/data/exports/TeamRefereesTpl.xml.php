...
<?php foreach ($this->teams as $team) { ?>
   <Row ss:Height="25.5">
    <Cell><Data ss:Type="String"><?php echo $team['team_desc']; ?></Data></Cell>
    <Cell><Data ss:Type="Number"><?php echo $team['points_processed']; ?></Data></Cell>
    <Cell <?php if (count($team['referees']) >= 3) echo 'ss:StyleID="s25"'; ?>><Data ss:Type="Number"><?php echo count($team['referees']); ?></Data></Cell>
<?php foreach($team['referees'] as $referee) { ?>
    <Cell ss:StyleID="s21"><Data ss:Type="String"><?php echo $referee['name'] . '&#10;' . 'Pri ' . $referee['priority'] . ', Max ' . $referee['points_max'] . ', Proc: ' . $referee['points_total'] . ', Team: ' . $referee['points_actual']; ?></Data></Cell>
<?php } ?>
   </Row>
...
<?php foreach($this->referees as $referee) { ?>
   <Row ss:Height="25.5">
    ...
    <Cell><Data ss:Type="String"><?php echo $referee['age']; ?></Data></Cell>
    <Cell><Data ss:Type="Number"><?php echo $referee['points_pending'];   ?></Data></Cell>
    <Cell><Data ss:Type="Number"><?php echo $referee['points_processed']; ?></Data></Cell>

<?php foreach($referee['teams'] as $team) { ?>
    <Cell ss:StyleID="s21"><Data ss:Type="String"><?php echo $team['team_desc'] . '&#10;' . 'Pri: ' . $team['priority'] . ', Max: ' . $team['points_max'] . ', Team ' . $team['points_actual']; ?></Data></Cell>
<?php }  ?>
