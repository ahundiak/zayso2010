 ...
 <Worksheet ss:Name="Teams">
  <Table 
   ...
   <Row>
    ...
    <Cell ss:StyleID="s26"><Data ss:Type="String">AYSO ID</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String">Home Phone</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String">Work Phone</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String">Cell Phone</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String">Home Email</Data></Cell>
    <Cell ss:StyleID="s26"><Data ss:Type="String">Work Email</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:StyleID="s27"><Data ss:Type="Number"><?php echo $team->coachHead->aysoid; ?></Data></Cell>
    <Cell ss:StyleID="s27"><Data ss:Type="String"><?php echo $team->coachHead->phoneHome->number; ?></Data></Cell>
    <Cell ss:StyleID="s27"><Data ss:Type="String"><?php echo $team->coachHead->phoneWork->number; ?></Data></Cell>
    <Cell ss:StyleID="s27"><Data ss:Type="String"><?php echo $team->coachHead->phoneCell->number; ?></Data></Cell>
    <Cell ss:StyleID="s27"><Data ss:Type="String"><?php echo $team->coachHead->emailHome->address; ?></Data></Cell>
    <Cell ss:StyleID="s27"><Data ss:Type="String"><?php echo $team->coachHead->emailWork->address; ?></Data></Cell>
    <Cell ss:StyleID="s27"
     ss:Formula="=CONCATENATE(RC[-10],&quot;-&quot;,RC[-9],&quot;-&quot;,TEXT(RC[-8],&quot;00&quot;),&quot; &quot;,RC[-7])">
