...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Games">
  <Table 
    ss:ExpandedColumnCount="13" 
    ss:ExpandedRowCount="<?php echo $this->eventCount + 1; ?>" 
    x:FullColumns="1"
    x:FullRows="1" 
   ...
   <Row>
    ...
    <Cell ss:StyleID="s16"><Data ss:Type="String">Coach A</Data></Cell>
    <Cell ss:StyleID="s16"><Data ss:Type="String">Phone A</Data></Cell>
    <Cell ss:StyleID="s16"><Data ss:Type="String">Away</Data></Cell>
    <Cell ss:StyleID="s16"><Data ss:Type="String">To</Data></Cell>
    <Cell ss:StyleID="s16"><Data ss:Type="String">Home</Data></Cell>
    <Cell ss:StyleID="s16"><Data ss:Type="String">Field</Data></Cell>
    <Cell ss:StyleID="s22"><Data ss:Type="String">Time</Data></Cell>
    <Cell ss:StyleID="s16"><Data ss:Type="String">Coach H</Data></Cell>
    <Cell ss:StyleID="s16"><Data ss:Type="String">Phone H</Data></Cell>
   </Row>
<?php 
