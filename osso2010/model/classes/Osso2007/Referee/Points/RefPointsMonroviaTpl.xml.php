...
<?php foreach ($this->teams as $team) { ?>
   <Row ss:Height="25.5">
    ...
    <Cell <?php if (count($team->referees) >= 30) echo 'ss:StyleID="s25"'; ?>><Data ss:Type="Number"><?php echo count($team->referees); ?></Data></Cell>
<?php foreach($team->referees as $referee) { $pri = $referee->getTeamPri($team); ?>
    <Cell ss:StyleID="s21"><Data ss:Type="String"><?php echo "{$referee->name1} (Priority: {$pri})"; ?></Data></Cell>
<?php } ?>
   </Row>
 ...
 <Worksheet ss:Name="Referees">
  <Table 
   ...
   <Row ss:Height="25.5">
    ...
    <Cell ss:StyleID="s22"><Data ss:Type="String">Game&#10;Count</Data></Cell>
...
<?php foreach($this->referees as $referee) { ?>
   <Row ss:Height="25.5">
    ...
    <Cell><Data ss:Type="Number"><?php echo $referee->gameCnt; ?></Data></Cell>

<?php foreach($referee->teams as $team) { ?>
    <Cell ss:StyleID="s21"><Data ss:Type="String"><?php echo $team->desc ?></Data></Cell>
<?php }  ?>
