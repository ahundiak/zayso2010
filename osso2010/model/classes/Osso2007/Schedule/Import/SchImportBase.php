<?php
class Osso2007_Schedule_Import_SchImportBase extends Cerad_Import
{
  ...
  protected function init()
  {
    ...
    $this->repoSchTeam = $this->context->repos->schTeam;
    $this->eventProject = $repos->project;
