...
?>
<form id="account-login-form" method="post" action="actionx/user-login">
<table class="entry" style="width: 600px;">
<tr><th colspan="2">User Login</th></tr>
<tr>
  <td>User Name</td>
  <td>
    <input id="account-login-form-account-name" type="text" name="account_name" size="30" value="" />
  </td>
</tr>
<tr>
  <td>Password</td>
...
<script type="text/javascript">
  ...
  $.ajax(
  {
    cache:    false,
    datatype: 'json',
    url:      'actionx/user-login-data',
    success: function(result)
    {
      var data = result.data || {};
      if (data.account_name) $('#account-login-form-account-name').attr('value',data.account_name);
    }
  });
