<?php
class Osso2007_Event_EventEditView extends Osso2007_View
{
  function init()
  {
    parent::init();
        
    $this->tplTitle   = 'Edit Game';
    $this->tplContent = 'Osso2007/Event/EventEditTpl.html.php';
  }
  function process($data)
  {
    ...
    if ($eventId)
    {
        ...
        if (count($events) != 1) die('Event not found ' . $eventId);
        $event = $events[$eventId];
        Cerad_Debug::dump($event); die('Event Edit View');
     }
     die('Got here');
