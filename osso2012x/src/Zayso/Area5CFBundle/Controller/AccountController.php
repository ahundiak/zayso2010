...
class AccountController extends BaseController
{
    public function signoutAction()
    {
        ...
        return $this->redirect($this->generateUrl('_area5cf_welcomex'));
    }
    public function signinAction()
    {
        ...
        return $this->render('Area5CFBundle:Account:signin.html.twig',$tplData);
    }
    public function signinPostAction()
    {
        ...
        if (is_array($account))
        {
            ...
            return $this->redirect($this->generateUrl('_area5c_account_signin'));
        }
        // Signin
        ...
        return $this->redirect($this->generateUrl('_area5cf_home'));
    }
