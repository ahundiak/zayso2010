...
/** ==================================================
 *  ORM\Entity
 * @ORM\Table(name="project_person_role",
     uniqueConstraints={
         @ORM\UniqueConstraint(name="project_person", columns={"person_id", "project_id", "role"})
   })
...
class ProjectPersonRole
{
  ...
  /**
   * @ORM\ManyToOne(targetEntity="Project", inversedBy="personRoles")
   * @ORM\JoinColumn(name="project_id", referencedColumnName="id")
   */
  protected $project;

  /**
   * @ORM\ManyToOne(targetEntity="Person", inversedBy="projectPersonRoles")
   * @ORM\JoinColumn(name="person_id", referencedColumnName="id")
   */
  protected $person;
  
  /** @ORM\Column(type="string",name="role",length=40) */
  protected $role = null;
