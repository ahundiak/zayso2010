...
If you are a referee or coach then you will probably want to: <br />
<?php echo $this->href('Create A Zayso Account','account_create') ?>. <br />
</p>
<hr />
<p>
...
<p>If you already have an account then login here.</p>
