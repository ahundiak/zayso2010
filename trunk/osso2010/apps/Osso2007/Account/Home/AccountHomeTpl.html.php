...
<br />
<?php echo $this->render('Osso2007/Account/Member/MemberListTpl.html.php'); ?>
<h3>Signing up to Referee</h3>
<p>
To sign up for a game, you must be certified as an AYSO referee in <a href="http://www.eayso.org">eAYSO</a>
...
<h3>Social Networking (Google,Facebook,Twitter etc.) Accounts</h3>
<p>
  One of the problems with sites like Zayso is that it is all too easy to forget your user name and password.
  Recovering passwords and such is just no fun at all.  However, you can now link your Zayso account to one or
  more social networking accounts such as Facebook.  Once linked, you can sign in to Zayso by clicking on the
  Facebook icon.  No more having to remember your Zayso information.<br />
  <a href="account_openid_link">Click here to link your social networking site.</a>
</p>