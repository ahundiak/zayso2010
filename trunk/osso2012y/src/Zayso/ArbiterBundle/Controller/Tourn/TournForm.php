...
use Zayso\CoreBundle\DataTransformer\USSF\IDTransformer;
use Zayso\CoreBundle\DataTransformer\StripTagsTransformer;
...
class TournForm extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        ...
        { 
            ...
            $resolver->setDefaults(array('validation_groups' => array($this->group)));
        }
    }
    ...
    {   
        ...
        $builder->get('ussfid'   )->appendClientTransformer(new IDTransformer());
