...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Schedule">
  <Table 
  	...
  	ss:ExpandedRowCount="<?php echo count($games) + 1; ?>"
  	x:FullColumns="1"
   	x:FullRows="1" 
   	ss:StyleID="s21" 
   ...
   <Row ss:AutoFitHeight="0">
    ...
    <Cell ss:StyleID="s27"><Data ss:Type="String"><?php echo $game->homeTeam; ?></Data></Cell>
    <Cell ss:StyleID="s27"><Data ss:Type="String"><?php echo $game->awayTeam; ?></Data></Cell>
    <?php
      $persons = $game->personsx;
      foreach($persons as $person) { ?>
    <Cell ss:StyleID="s29"><Data ss:Type="String"><?php echo $person['name']; ?></Data></Cell>
    <?php } ?>
   </Row>
   <?php } ?>
  </Table>
